...
#update_file $DEPLOYMENT_SERVER_FILE "ehxa/server:.*" "ehxa/server:$COMMIT_HASH" $OS
update_file $DEPLOYMENT_CLIENT_FILE "ehxa/client:.*" "ehxa/client:$COMMIT_HASH" $OS
#update_file $DEPLOYMENT_MYSQL_FILE "ehxa/mysql:.*" "ehxa/mysql:$COMMIT_HASH" $OS
