...
update_file $DEPLOYMENT_SERVER_FILE "user/server:.*" "user/server:$COMMIT_HASH" $OS
update_file $DEPLOYMENT_CLIENT_FILE "user/client:.*" "user/client:$COMMIT_HASH" $OS
update_file $DEPLOYMENT_MYSQL_FILE "user/mysql:.*" "user/mysql:$COMMIT_HASH" $OS
